...
def parse_training_args():
    ...
    # set save_path, log filepath and args filepath for training
    if args.uid == None:
    ...
    # Below arguments could not input by user since it throw error in the first parse_args()
    args.save_path = save_path # the output dir of weights
    args.log = os.path.join(save_path,'log.txt') # the log file in training
    args.arg = os.path.join(save_path,'args.txt') # the args used
